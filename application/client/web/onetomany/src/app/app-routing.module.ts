...
{ path : 'createsubjects', loadChildren: () => import('./createsubjects/createsubjects.module').then(m => m.CreatesubjectsModule), canActivate: [AuthGuard] } , 
{ path : 'createstudents', loadChildren: () => import('./createstudents/createstudents.module').then(m => m.CreatestudentsModule), canActivate: [AuthGuard] } , 
{ path : 'searchstudent', loadChildren: () => import('./searchstudent/searchstudent.module').then(m => m.SearchstudentModule), canActivate: [AuthGuard] } , 
];
